...
const App = {
    ...
    /**
     * Génère le contenu HTML de la sidebar selon le mode
     */
    _configurerSidebar(mode) {
        const nav = document.getElementById('sidebar-nav');
        if (!nav) return;

        if (mode === 'autonome') {
            nav.innerHTML = `
                <div class="sidebar-item active" data-page="accueil-autonome" onclick="AutonomeDashboard.afficher()">
                    <span class="sidebar-item-icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span>
                    Tableau de bord
                </div>
                <div class="sidebar-separator"></div>
                <div class="sidebar-item" data-page="module-autonome-revenus" onclick="AutonomeRevenus.afficher()">
                    <span class="sidebar-item-icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></span>
                    Revenus
                </div>
                <div class="sidebar-item" data-page="module-autonome-depenses" onclick="AutonomeDepenses.afficher()">
                    <span class="sidebar-item-icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></span>
                    Dépenses
                </div>
                <div class="sidebar-item" data-page="module-autonome-factures" onclick="AutonomeFactures.afficher()">
            ...
            nav.innerHTML = `
                <div class="sidebar-item active" data-page="accueil" onclick="App.retourAccueil()">
                    <span class="sidebar-item-icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span>
                    Tableau de bord
                </div>
                <div class="sidebar-separator"></div>
                <div class="sidebar-item" data-page="module-general" onclick="General.afficher()">
                    <span class="sidebar-item-icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></span>
                    Module Général
                </div>
                <div class="sidebar-item" data-page="module-ventes" onclick="Ventes.afficher()">
                ...
                <div class="sidebar-separator"></div>
                <div class="sidebar-item" data-page="module-encaissements" onclick="Encaissements.afficher()">
                    <span class="sidebar-item-icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></span>
                    Encaissements
                </div>
                <div class="sidebar-item" data-page="module-paiements" onclick="Paiements.afficher()">
                    <span class="sidebar-item-icon"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></span>
                    Paiements
                </div>
                <div class="sidebar-separator"></div>
                <div class="sidebar-item" data-page="module-immobilisations" onclick="Immobilisations.afficher()">
     ...
     */
    _mettreAJourSidebarActive(pageId) {
    ...
    _configurerMode(mode) {
        ...
        // Configure sidebar for the mode
        this._configurerSidebar(mode);
    },
    ...
    afficherPage(pageId) {
        ...
        this._mettreAJourSidebarActive(pageId);
    },
